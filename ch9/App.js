...
//   handleAppStateChange = ( currentAppState) => { // 화살표함수를 사용해야 this를 사용할 수 있습니다.
//     this.setState({curr:currentAppState});
...
//         {
//           this.state.curr === "active" && <Text>활성화</Text>
//         }
//       </View>
//     )
//   }
...
//     Geolocation.getCurrentPosition( //현재 위치를 가져오면 coords객체와 타임스탬프를 포함한 객체 반환
//       (info) => {
...
//     let id = Geolocation.watchPosition( //현재위치를 가져오고 디바이스의 위치가 변경되면 자동으로 호출, 물리적 위치가 변경되면 실시간으로 바뀜
