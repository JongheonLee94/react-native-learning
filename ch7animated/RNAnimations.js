...
//   marginTop = new Animated.Value(20); // marginTop이라는 클래스 속성을 만들고 애니메이션효과를 만들고, 시작 값을 전달함(여기서는 20)
...
//       //두번째인자, 설정값
//       {
//         toValue: 200, //toValue는 애니메이션이 작동해서 변한 value값
//         duration: 1000, //걸리시간   밀리 초 단위
//       }
//     ).start();
//   }
//   render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Animated.View style={{ width: this.animatedWidth }}>
          ...
          <TextInput // D
            style={[styles.input]}
            onBlur={() => this.animate(200)}  //비활성화 때
            onFocus={() => this.animate(325)} //텍스트입력창을 눌러 활성화 때
...
//           toValue: 1,
//           duration: 1800,
//           easing: Easing.linear,//기본은 점점빨라졌다 다시 점점 느려지는 방식 linear는 일정하게 됩니다.
//         }
//       )
//     ).start()
//   }
...
//     const rotation = this.animatedRotation.interpolate({ //한국어로 '보간하다' 입니다. 원래 값을 비율에 맞게 옮기는 것입니다.   여기서는 0과 1을 0deg에서 360deg 사이로 옶깁니다.
//       //애니매이션의 시작과 끝 (0 과 1)
//       inputRange: [0, 1],
//       //애니매이션의 진행 변화 rotate는 deg를 사용하므로 맞춰줘야합니다.
...
//         {
//           loading ? (
//             <Animated.Image //Animated.Image입니다.
...
//   }
//   animate = () => {
//     Animated.parallel([ //애니메이션을 동시에 실행을 위해서 사용합니다.
//       Animated.timing(
//         this.animatedTitle, //마진 탑을 화면 변경해서 화면 밖에서 나오도록합니다.
//         {
//           toValue: 200,
//           duration: 800,
//         } 
...
//         <Animated.View style={{ marginRight: this.animatedButton }}>
